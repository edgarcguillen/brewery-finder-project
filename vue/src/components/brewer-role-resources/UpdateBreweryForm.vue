<template>
  <div>
    <base-modal v-if="isSuccessful">
      <h3>Successfully updated brewery</h3>
    ...
    <div id="register" class="form-container">
      ...
      <form @submit.prevent="submitForm()" class="form">
        ...
        <div class="buttons-container">
          <base-button class="submit-button">Update brewery</base-button>
  ...
  methods: {
    ...
    submitForm() {
      const newBrewery = {
        ...
        breweryStreet: this.brewery.breweryStreet,
